...
from metaheuristicas import grasp
...
def executeGrasp(pathToDat, solverParams):
    ...
    params["feasibleNurses"] = grasp.generateAllNurses(params)
    # (cost, sol) = grasp.grasp(params, grasp.constructNurses, grasp.localSearchNurses, 50)
    (cost, sol) = grasp.parallelGrasp(params, grasp.constructNurses, grasp.localSearchNurses, 50)
...
if __name__ == '__main__':
    ...
    solverParams = {}
    executeSolver(autoGeneratedData, executeGrasp, solverParams)
